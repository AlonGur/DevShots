...
for(i=0;i<lectures.length;i++){
    let lectureTemplate = new EJS({url:'/source/templates/lecturesHTML'}  ) render(lecHtmlTemplate);
    lectureWrapper.innerHTML+=template(lectures[i].speaker, lectures[i].title);
}
