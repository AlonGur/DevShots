...
//get template
var usefulTemplate=document.getElementById('usefulInfoTemplate');
var target=document.querySelector.usefulInfo
someItem=Handlebars.compile(usefulTemplate);

for (i of usefulTitle){
    anItem=someItem(usefulTitle[i]);
