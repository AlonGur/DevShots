...
getandcompileTemplate('/source/templates/lecturesHTML',lectures ,lectureWrapper );
...
getandcompileTemplate('source/templates/usefulItem',usefulData,document.querySelector('.usefulItemsWrapper'))
