    ...
    if (arriveReq.readyState === 4) {
        if (arriveReq.status === 200) {
            ...
            if (arriveInfo) {
                ...
                parkTemp = arriveInfo.template;
                parkTemp2 = Handlebars.compile(parkTemp);
                arriveInfo.parking=new object;
                console.log(arriveInfo.parking)
                parkingTarget.innerHTML += parkTemp2(arriveInfo.parking);
