...
var lectureWrapper=document.querySelector('.lectureItemssWrapper');
var speakers=['שימי תבורי','אלונזו מוזלי','רפיק חלבי','רפיק בשרי','רפיקי הקוף','משה בתיבה'];
...
var source   = document.getElementById("lectureTemplate").innerHTML;
var template = Handlebars.compile(source);
//var context=lectures[0];
for(i in lectures){
    var html    = template(lectures[i]);
