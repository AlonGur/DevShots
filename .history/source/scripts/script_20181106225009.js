...
let ejs = require('ejs'),
    myLec={speaker:'rafiki'}
    html = ejs.render('/source/templates/lectureHTML.ejs', {speaker:speaker});

   lectureWrapper.innerHTML+=html;

   let template = ejs.compile(lecHtmlTemplate, options);
template(myLec);
