...
lecTempReq.open('GET','/source/templates/lecturesHTML.ejs');
var lecHtmlTemplate;
...
var myLec={title: `you're all baboons`, speaker:'rafiki'}
var lectureWrapper=document.querySelector('.lecturesWrapper')
for(i=0;i<lectures.length;i++){
    var lecitem = new EJS({url: 'cleaning.ejs'}).render(data);
    let lecitem=ejs.render(lecHtmlTemplate,myLec)
    lectureWrapper.innerHTML+=lecitem;
}
