...
var lectures=document.querySelectorAll('.lectureItem');
var lecWrap=document.querySelector('.lectureItemsWrapper');



function addLecture(){
    var firstLec=lecWrap.firstElementChild;
    var copylec=firstLec.cloneNode;
    document.querySelector('.lectureItemsWrapper').appendChild(copylec);
/*
    var lecContent= `
